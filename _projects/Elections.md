...
For more information about the first deployment, read Sanjiva's blog: <a href="https://medium.com/@sanjiva.weerawarana/building-software-to-run-elections-in-sri-lanka-and-beyond-188237a962bc" target="_blank" rel="noopener noreferrer">Building software to run elections in Sri Lanka (and beyond)</a>.

The source code can be found here: <a href="https://github.com/ECLK/" target="_blank" rel="noopener noreferrer">https://github.com/ECLK/</a>.
